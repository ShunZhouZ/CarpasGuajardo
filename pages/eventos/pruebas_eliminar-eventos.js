...
const Eventos = (props) => {
    ...
    return (
        <div className="container">
            <h1 className="display-3 text-center mb-5">Búsqueda de eventos</h1>
            ...
            <div className="card-container">
                {sortedEvents.map((event, index) => (
                    <Card key={event._id}>
                        <Card.Body>
                            <div className="row">
                                <Card.Title className="modal-title">Evento {index + 1}</Card.Title>
                                <div className="col-md-6">
                                    ...
                                    <Card.Text>Inicio evento: {moment(event.fecha_inicio).format("dddd DD-MM-YYYY  HH:mm")}</Card.Text>
                                    <Card.Text>Fin evento: {moment(event.fecha_termino).format("dddd DD-MM-YYYY  HH:mm")}</Card.Text>
                                    <Card.Text>m<sup>2</sup>: {event.metros_cuadrados}</Card.Text>
