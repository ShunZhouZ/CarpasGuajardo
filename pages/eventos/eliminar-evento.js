...
const Eventos = (props) => {
  ...
  const deleteElement = async (id) => {
    ...
    if (confirmDelete) {
      ...
      const deletedEventName = deletedEvent ? deletedEvent.nombre_cliente : "";
      setDeletedEventName(deletedEventName);
  ...
  return (
    <div style={{ marginLeft: "40px", marginRight: "40px" }}>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>{`Se ha eliminado el evento de "${deletedEventName}" correctamente.`}</Modal.Body>
        <Modal.Footer>
